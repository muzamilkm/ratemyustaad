                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            const Text(
                              'This dashboard allows you to manage admin users for the Rate My Ustaad application. '
                              'Admins have access to additional features and can add or remove other admins.',
                              style: TextStyle(
                                fontFamily: 'Manrope',
                                fontSize: 14,
